...
class AgoraRequester: NSObject, NSURLSessionDelegate {
    ...
    func PostQuery(params: Dictionary<String,AnyObject>, info: ((Dictionary<String,AnyObject>) -> Void)?, imageReceived: ((String,Int,NSData) -> Void)?, failure: ((Bool,Int?,String?,Int,String) -> Void)?){
    ...
    func UserPosts(params: Dictionary<String,AnyObject>, info: ((Dictionary<String,AnyObject>) -> Void)?, imageReceived: ((String,Int,NSData) -> Void)?, failure: ((Bool,Int?,String?,Int,String) -> Void)?){
        ...
        if Reachability.isConnectedToNetwork(){
            ...
            //init request, set target URL
            var infoRequest = NSMutableURLRequest(URL: NSURL(string: self.baseURLst + "userposts/")!)
